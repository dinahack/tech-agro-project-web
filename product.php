...
<body>
	...
	<div style="margin-top: 50px">
		<form style="float: right;margin-right: 20px;margin-top: 20px;" method="post" action="search.php">
		    <input type="text" name="data" placeholder="Enter cropname/District" style="border-radius: 10px;padding: 10px;">
		    <button name="search" style="border-radius: 10px;padding: 10px;">search</button>
		</form>
	</div>
